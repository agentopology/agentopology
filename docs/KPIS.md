...
| L2.2 | Test count and pass rate | `npx vitest run` | ✅ **1461 / 1461** | 100%, count grows with surface |
...
| L2.6 | Docs drift | `CLAUDE.md` claims vs measured | ✅ refreshed: **1461 tests / 91 rules / 10 examples / 5 exporters**. Was 1141 / 82 / 5 / 2. | refreshed at each release |
